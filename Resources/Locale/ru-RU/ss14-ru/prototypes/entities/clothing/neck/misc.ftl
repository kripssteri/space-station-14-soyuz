...
ent-ClothingNeckLawyerbadge = значок юриста
    .desc = Значок, свидетельствующий что владелец является сотрудником пожалуй самого уникального отдела станции.
ent-ActionStethoscope = Прослушать стетоскопом
    .desc = { "" }
ent-Dinkystar = наклейка-звёздочка
    .desc = Маленькая звёздочка только для самых трудолюбивых сотрудников Советской Гражданской Милиции! Она уже даже не липкая.
