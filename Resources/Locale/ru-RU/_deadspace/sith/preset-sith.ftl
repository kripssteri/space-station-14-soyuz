...
sith-role-greeting =
    ...
    Захватите станцию, подчиняя командования с помощью силы, после вызовете шаттл эвакуации. 
    Очистись или умри, пытаясь!
objective-condition-subordination-command-title =
    Подчинить { $count } { $count ->
        [one] члена командования
        [few] членов командования
       *[other] членов командования
    }.
round-end-system-sith-shuttle-called-announcement = Внимание, всему коллективу предприятия! Станция перешла под контроль ордена Ностор. Немедленно покиньте станцию на эвакуационном шаттле. При невозможности эвакуарироваться, соблюдайте все требования захватчиков. НКВБ уже ведёт переговоры о вашем освобождении.
