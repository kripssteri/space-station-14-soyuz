...
# Command
holopad-command-bridge = Станционный Совет - Мостик
holopad-command-vault = Станционный Совет - Хранилище
holopad-command-bridge-hallway = Станционный Совет - Коридор мостика
holopad-command-meeting-room = Станционный Совет - Комната собраний
holopad-command-lounge = Станционный Совет - Зона отдыха
holopad-command-captain = Станционный Совет - Капитан
holopad-command-hop = Станционный Совет - НОК
holopad-command-cmo = Станционный Совет - ГВ
holopad-command-qm = Станционный Совет - Завхоз
holopad-command-ce = Станционный Совет - СИ
holopad-command-rd = Станционный Совет - ГНС
holopad-command-hos = Станционный Совет - НМ
# Science
...
# Security
holopad-security-front = СГМ - Приёмная
holopad-security-brig = СГМ - Участок
holopad-security-warden = СГМ - Комната оперативного дежурного
holopad-security-interrogation = СГМ - Допрос
holopad-security-breakroom = СГМ - Комната отдыха
holopad-security-detective = СГМ - Каюта следователя
holopad-security-perma = СГМ - Следственный изолятор
holopad-security-courtroom = СГМ - Зал суда
holopad-security-lawyer = СГМ - Кабинет юристов
holopad-security-armory = СГМ - Оружейная
holopad-security-locker-room = СГМ - Раздевалка
holopad-security-brig-med = СГМ - Медицинский участок
holopad-security-evac-checkpoint = СГМ - КПП эвакуации
holopad-security-arrivals-checkpoint = СГМ - КПП прибытия
# Service
